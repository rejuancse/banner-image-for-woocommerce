...
$biw_product_single_styles_array = array(
    array(
    ...
    array(
        ...
        'type'      => 'dropdown',
        'option'    => array(
            '400'    => __('300', 'banner-image-for-woocommerce'),
    ...
    # Save Function
    array(
        'id'        => 'promotionalbanner_product_single_style_admin_tab',
        'type'      => 'hidden',
        'value'     => 'tab_style',
    ),
);

banner_image_function()->generator( $biw_product_single_styles_array );
