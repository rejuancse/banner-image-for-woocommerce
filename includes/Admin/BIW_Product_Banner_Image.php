...
if ( ! class_exists( 'BIW_Product_Banner_Image' ) ) {
    class BIW_Product_Banner_Image {
        ...
        public function wp_banner_image_data_tab( $product_data_tabs ) {
            $product_data_tabs['product-banner-image'] = array(
                'label'     => __( 'Product Banner Image', 'biw' ),
        ...
        function wppb_banner_image_data_fields($post_id){
            ...
            $woocommerce_meta_field = array(
                ...
                array(
                    ...
                    'label'         => __('Enable Banner Image', 'biw'),
                    'desc_tip'      => 'true',
                    'type'          => 'checkbox',
                    'placeholder'   => __('Enable Banner Image', 'biw'),
                ...
                array(
                    ...
                    'desc_tip'      => 'true',
                    'type'          => 'text',
                    'placeholder'   => __('Write Banner Sub Heading', 'biw'),
                    'value'         => '',
                ...
                array(
                    ...
                    'desc_tip'      => 'true',
                    'type'          => 'text',
                    'placeholder'   => __('Write Banner Title', 'biw'),
                    'value'         => '',
                    'field_type'    => 'textfield',
                ),
                ...
                array(
                    ...
                    'desc_tip'      => 'true',
                    'type'          => 'text',
                    'placeholder'   => __('Write short description', 'biw'),
                    'value'         => '',
                ...
                array(
                    ...
                    'label'         => __('Button Name', 'biw'),
                    'desc_tip'      => 'true',
                    'type'          => 'text',
                    'placeholder'   => __('Write Banner button Name', 'biw'),
                    'value'         => '',
                    'field_type'    => 'textfield',
                ),
                ...
                array(
                    ...
                    'label'         => __('Banner URL', 'biw'),
                    'desc_tip'      => 'true',
                    'type'          => 'text',
                    'placeholder'   => __('Add custom URL', 'biw'),
                    'value'         => '',
                    'field_type'    => 'textfield',
                ),
                ...
                array(
                    ...
                    'desc_tip'      => 'true',
                    'type'          => 'checkbox',
                    'placeholder'   => __('Enable Link full Banner', 'biw'),
                    'field_type'    => 'checkboxfield'
                ),
            );
            ?>
        ...
        */
        function save_banner_info_action($post_id) {
            ...
            biw_function()->update_meta($post_id, 'wp_product_banner_image', wp_slash($data_json));
        }
