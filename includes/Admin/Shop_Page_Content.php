...
class Shop_Page_Content {
    ...
    public function Shop_Page_Banner() {
        ...
        $tabs = apply_filters('biw_shop_page_banner_image_panel_tabs',
            array(
        ...
        echo '<h2 class="bannerimage-setting-title">' . esc_html__("Shop Page Banner Image Settings", "banner-image-for-woocommerce") . '</h2>';
