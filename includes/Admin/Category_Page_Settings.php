...
class Category_Page_Settings {
    public function Category_Page_Banner() {
        ...
        $tabs = apply_filters('biw_category_page_banner_image_panel_tabs',
            array(
                'general_settings' => array(
                    'tab_name' => __('General Settings','banner-image-for-woocommerce'),
        ...
        echo '<h2 class="bannerimage-setting-title">' . esc_html__("Category Page Banner Image Settings", "banner-image-for-woocommerce") . '</h2>';
