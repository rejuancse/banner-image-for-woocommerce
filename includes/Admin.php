...
class WC_Settings_Banner_Image_Plugin extends WC_Settings_Banner_Image_Page {
    ...
    public function get_sections() {
        $sections = array(
            'section-0'         => __( 'Style', 'wcpb' ),
            'section-1'         => __( 'Shop Page Banner Image', 'wcpb' ),
        );
        ...
        switch( $section ) {
			...
			default:
				$settings = array(
					...
					'title' => array(
						'name' => __( 'Enable Gift Form', 'wcpb' ),
						'type' => 'checkbox',
						'desc' => __( 'Enable Gift Form', 'wcpb' ),
						'id'   => 'wc_settings_enable_btn',
						'default' => true
					),
					'order_gift_btn' => array(
                        'name' 	=> __( 'Oder as a Gift', 'wcpb' ),
                        'type' 	=> 'text',
                        'desc' 	=> __( 'Oder as a Gift Button text change', 'wcpb' ),
