        ...
        */
        public function add_category_image ( $taxonomy ) { ?>
            <div class="form-field term-group">
                ...
                <label for="category-image-id"><?php _e('Upload Banner BG Image', 'wpbi'); ?></label>
                <input type="hidden" id="category-sdimage-id" name="category-image-id" class="custom_media_url" value="">
            ...
            <tr class="form-field term-group-wrap">
                <th scope="row">
                    <label for="category-image-id">
                        <?php _e( 'Wp Category Banner BG Image', 'wpbi' ); ?>
                    </label>
                </th>
