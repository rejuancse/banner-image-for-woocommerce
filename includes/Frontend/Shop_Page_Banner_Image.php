...
class Shop_Page_Banner_Image {
    ...
    public function product_banner_activation_css() { 
        ...
        // Button
        $button_text_color = get_option( 'shop_page_banner_button_text_color', '250' );
        $button_bg_color = get_option( 'shop_page_banner_button_bg_color', '250' );
        $button_text_hover_color = get_option( 'shop_page_banner_button_text_hover_color', '250' );
        $button_bg_hover_color = get_option( 'shop_page_banner_button_bg_hover_color', '250' );
        $button_font_size = get_option( 'shop_banner_button_font_size', '250' );
        $button_font_weight = get_option( 'shop_banner_button_font_weight', '250' );
        $button_line_height = get_option( 'shop_banner_button_line_height', '250' );
